...
void setupTable () {
  ...
  translationTable[PS2_KEY_R_ALT] = 0x38;
  translationTable[PS2_KEY_L_CTRL]=0x1D;
  translationTable[PS2_KEY_R_CTRL]=0x1D;
...
void loop() 
{
    ...
    if( !( c & PS2_BREAK ) ) 
  {
    switch (c & 0xff)
    {
      ...
      //case PS2_KEY_PRTSCR: _write(0xE0); _write(0x2A); _write(0xE0); _write(0x37); break ;
  ...
  if( ( c & PS2_BREAK ) ) 
  {
    switch (c & 0xff)
    {
      ...
      //case PS2_KEY_PRTSCR: _write(0x2A); _write(0x37 | 0x80); break ;
